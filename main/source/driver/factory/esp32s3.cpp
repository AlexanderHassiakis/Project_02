/**
 * @brief ESP32-S3 factory implementation details.
 */
#include <cstdint>
#include <memory>
...
{
    //! @note How can I create a GPIO input in your design?
...
// -----------------------------------------------------------------------------
std::unique_ptr<tempsensor::Interface>Esp32s3::tempSensor(std::uint8_t pin, 
    adc::Interface& adc) noexcept
{
